...
class FriendsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create friend" do
    assert_difference('Friend.count') do
      post friends_url, params: { friend: { first_name: @friend.first_name, lasclearg: @friend.lasclearg } }
    end
  ...
  test "should update friend" do
    patch friend_url(@friend), params: { friend: { first_name: @friend.first_name, lasclearg: @friend.lasclearg } }
