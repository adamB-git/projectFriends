...
class FriendsListsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create friends_list" do
    assert_difference('FriendsList.count') do
      post friends_lists_url, params: { friends_list: { email: @friends_list.email, first_name: @friends_list.first_name, last_name: @friends_list.last_name, notes: @friends_list.notes, phone: @friends_list.phone } }
    end
  ...
  test "should update friends_list" do
    patch friends_list_url(@friends_list), params: { friends_list: { email: @friends_list.email, first_name: @friends_list.first_name, last_name: @friends_list.last_name, notes: @friends_list.notes, phone: @friends_list.phone } }
